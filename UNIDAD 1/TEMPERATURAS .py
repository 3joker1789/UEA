...
print("Quito ultimos 3 meses")
temperaturas = [
    [  # Quito
        [  # Semana 1
            {"day1": "Lunes", "temp": 78},
            {"day2": "Martes", "temp": 80},
            {"day3": "Miércoles", "temp": 82},
            {"day4": "Jueves", "temp": 79},
            {"day5": "Viernes", "temp": 85},
            {"day6": "Sábado", "temp": 88},
            {"day7": "Domingo", "temp": 92}
        ],
...
for ciudad in temperaturas:
    for semana in ciudad:
        ...
        print(f'El promedio real es :{promedio}')

print("Guayaquil ultimos 3 meses")
temperaturas = [
    [  # Guayaquil
        [  # Semana 1
            {"day1": "Lunes", "temp": 78},
